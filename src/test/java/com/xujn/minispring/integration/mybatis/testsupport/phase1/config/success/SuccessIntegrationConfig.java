package com.xujn.minispring.integration.mybatis.testsupport.phase1.config.success;
...
@Configuration
public class SuccessIntegrationConfig {

    @Bean
    public CountingDataSource dataSource() throws Exception {
        return IntegrationTestDataSupport.countingDataSource("mini_mybatis_integration_success");
    }
